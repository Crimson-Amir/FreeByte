text_transaction = {
    ...
    "vpn_service_activated": {
        ...
        "fa": "✅ سرویس VPN شما با نام {0} فعال شد!"
              ...
              "\n\n🌏 شما میتوانید بدون خاموش کردن VPN به سرویس های ایرانی دسترسی داشته باشید."
              "\n\n🎬 همچنین میتوانید با ورود به فیلیمو | فیلم نت به صورت رایگان فیلم تماشا کنید."
    ...
    "vpn_service_activated_unlimited_server": {
        ...
        "fa": "\n\n🔷 سرور های نامحدود ترافیک سرویس شما را 10 برابر میکنند",
    },
