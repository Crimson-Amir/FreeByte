...
text_transaction = {
    ...
    "select_section": {
        ...
        "fa": "برای ادامه بخش مورد نظر خود را انتخاب کنید:",
    },
    ...
    "recent_transactions": {"en": "• Recent Transactions:", "fa": "• تراکنش‌های اخیر:"},
    "receive_money": {"en": "💰 Received", "fa": "💰 دریافت"},
    "spend_money": {"en": "💸 Spend", "fa": "💸 برداشت"},
    "irt": {"en": "IRT", "fa": "تومان"},
    "usd": {"en": "USD", "fa": "دلار"},
    "no_transaction_yet": {
    ...
    "wallet_page_title": {"en": "Your Wallet Overview:", "fa": "اطلاعات کیف پول شما:"},
    "wallet_balance_key": {"en": "• Balance:", "fa": "• موجودی حساب:"},
    "last_transaction": {"en": "• Last Transaction:", "fa": "• آخرین تراکنش:"},
    ...
    "invoice_extra_data": {"en": "• Invoice Details:", "fa": "• اطلاعات فاکتور:"},
    "charge_wallet": {"en": "Add Credit to Wallet", "fa": "افزایش اعتبار کیف پول"},
    "buy_vpn_service": {"en": "Purchase VPN Service", "fa": "خرید سرویس VPN"},
    "upgrade_vpn_service": {
        "en": "Upgrade VPN Service #{0}",
        "fa": "ارتقاء سرویس VPN شماره {0}",
    },
    "traffic": {"en": "Data Traffic:", "fa": "• ترافیک (حجم):"},
    "wallet_credit_label": {"en": "Wallet Balance:", "fa": "اعتبار کیف پول:"},
    "period": {"en": "Duration:", "fa": "• دوره زمانی:"},
    ...
    "payment_gateway_label": {"en": "Payment Gateway:", "fa": "درگاه پرداخت:"},
    "zarinpal_label": {"en": "ZarinPal", "fa": "زرین پال"},
    "cryptomus_label": {"en": "Cryptomus", "fa": "کریپتوموس"},
    "just_for_show": {
    ...
    "not_paid": {"en": "❌ Not Paid", "fa": "❌ پرداخت نشده"},
    "paid": {"en": "✔️ Paid", "fa": "✔️ پرداخت شده"},
    "refund": {"en": "↩️ Refunded", "fa": "↩️ بازپرداخت شده"},
    ...
    "payment_authority": {"en": "Payment Authority:", "fa": "شناسه پرداخت:"},
    "invite_firend": {
        "en": "",
        "fa": "",
    },
    ...
    "without_caption": {"en": "Without Caption", "fa": "بدون توضیحات"},
    "ticket_was_answered": {
        "en": "🎯 You recive message from admin",
        "fa": "🎯 :یک پیام از مدیر دریافت کردید",
    },
    "action_canceled": {"en": "Action Canceled✅", "fa": "عملیات کنسل شد✅"},
    "send_new_ownership_user_id": {
        "en": "Please send new user chat id.",
        "fa": "لطفا آیدی فرد مورد نظرتون رو بفرستید.",
    },
    "ask_for_assurnace": {
    ...
    "unknown_message": {
        "en": "message in unknown.",
        "fa": "دستور اشتباه است. لطفا گزینه درست را انتخاب کنید.",
    },
}
...
keyboard_transaction = {
    ...
    "menu_services": {"en": "Services", "fa": "خرید سرویس"},
    "wallet": {"en": "👝 Wallet", "fa": "👝 کیف پول"},
    "ranking": {"en": "👥️ Ranking", "fa": "👥️ رتبه‌بندی"},
    "setting": {"en": "⚙️ Settings", "fa": "⚙️ تنظیمات"},
    "my_services": {"en": "My Services 🎛", "fa": "🎛 سرویس‌های من"},
    "invite": {"en": "👥️ Invite Firends", "fa": "👥️ دعوت از دوستان"},
    "back_button": {"en": "Back ↰", "fa": "↰ برگشت"},
    "bot_main_menu": {"en": "Main Menu ↵", "fa": "صفحه اصلی ربات ↵"},
    "confirm": {"en": "Confirm ✓", "fa": "✓ تایید"},
    "help_button": {"en": "📚 Help & Support", "fa": "📚 راهنما و پشتیبانی"},
    "cancel_button": {"en": "Cancel ✘", "fa": "✘ انصراف"},
    "financial_transactions": {
        "en": "• Financial Transactions",
        "fa": "• تراکنش‌های مالی",
    },
    "increase_balance": {"en": "Increase Balance ↟", "fa": "افزایش موجودی ↟"},
    "refresh": {"en": "⟳ Refresh", "fa": "⟳ تازه‌سازی"},
    "buy_vpn_service_label": {"en": "🛍️ Buy VPN Service", "fa": " 🛒 خرید سرویس VPN"},
    "vpn_services_label": {"en": "VPN Services", "fa": "سرویس‌های VPN"},
    "vpn_setting_label": {"en": "VPN Settings", "fa": "تنظیمات VPN"},
    "iran_payment_gateway": {"en": "Iran Payment Gateway", "fa": "درگاه پرداخت بانکی"},
    "cryptomus_payment_gateway": {"en": "Pay with Crypto", "fa": "پرداخت با کریپتو"},
    "pay_with_wallet_balance": {"en": "Pay with Wallet", "fa": "پرداخت با کیف پول"},
    "not_enough_rank": {
    ...
    "yes_im_sure": {"en": "Yes, I’m Sure", "fa": "بله، مطمئنم"},
    "no": {"en": "No", "fa": "خیر"},
    "change_language_setting": {"en": "🌎 Change Language", "fa": "🌎 تغییر زبان"},
    "vpn_guide_label": {"en": "VPN Guide", "fa": "راهنما VPN"},
    "previous": {"en": "⬅️ Previous", "fa": "⬅️ قبلی"},
    "next": {"en": "Next ➡️", "fa": "بعدی ➡️"},
    "recive_service": {"en": "Recive Service ↧", "fa": "دریافت سرویس ↧"},
    "get_vpn_test_label": {"en": "🎁 Get VPN Test", "fa": "🎁 دریافت تست VPN"},
    "ticket_new_message": {"en": "🆕 New Message", "fa": "🆕 پیام جدید"},
    "create_ticket_label": {
