...
import setting
from utilities_reFactore import FindText, message_token, handle_error, cancel_user as cancel
...
async def create_ticket(update, context):
    ...
    user_detail = update.effective_chat
    ft_instance = FindText(update, context)
    keyboard = [[InlineKeyboardButton(await ft_instance.find_keyboard('cancel_button'), callback_data='cancel_user_ticket_conversation')]]
