...
from vpn_service import buy_and_upgrade_service, my_service_detail, vpn_setting_menu, vpn_guid, panel_api, statistics
...
if __name__ == '__main__':
    ...
    application.job_queue.run_repeating(statistics.statistics_timer, interval=60, first=0)
